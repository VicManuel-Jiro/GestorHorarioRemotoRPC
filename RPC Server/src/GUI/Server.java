...
import objetos.ServerObject_RPC;
...
public class Server extends javax.swing.JFrame {
    ...
    public Server() {
        ...
        try{iniciar_RPC();}catch(BadLocationException e){this.txtlog.append("ha ocurrido un error al iniciar RCP");}
    }
...
public void iniciar_RPC() throws BadLocationException {
        ...
        try {
            ...
            Write("RPC ejecutandose correctamente, IP: "+ip.getHostAddress());
        } catch (BadLocationException|UnknownHostException e) {
